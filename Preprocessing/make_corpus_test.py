...
out_prob = [[0.65, 0.34, 0.005, 0.005], \
            [0.005, 0.65, 0.34, 0.005], \
            [0.005, 0.005, 0.65, 0.34], \
            [0.34, 0.005, 0.005, 0.65], \
            [0.34, 0.65, 0.005, 0.005], \
            [0.65, 0.005, 0.005, 0.34]]

out_uniform = [0.25, 0.25, 0.25, 0.25]

num_context = 10

stop_prob = [0.05, 0.05, 0.05, 0.05, 0.05, 0.90, 0.1, 0.1, 0.1, 0.1]

def main():
    output_file_name = 'data/corpus_test.txt'
